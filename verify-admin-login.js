  ...
  try {
    ...
    if (!admin) {
      ...
      if (passwordMatch) {
        ...
        log('\n🔧 Resetting password to "admin123"...', 'yellow');
        
        const newHashedPassword = await bcrypt.hash('admin123', 8);
    ...
    console.log(`  Password: ${color.green}admin123${color.reset}`);
    console.log(`\n${color.cyan}NEXT STEPS:${color.reset}`);
    console.log(`  1. Go to: https://folushovictoryschools.netlify.app/login`);
